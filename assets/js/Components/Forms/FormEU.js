        ...
        tasks = this.formData.tasks.map((item)=>{
            return (
                <tr>
                    ...
                    <td><label className="control control--checkbox"><input className="checkbox" type="checkbox" onChange={(e)=>{this.onChange(e,item)}}/><div className="control__indicator"></div></label></td>
                </tr>
            );
        });
        return tasks; 
